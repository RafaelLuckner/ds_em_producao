...
class Rossmann( object ):
    def __init__(self):
        self.home_path = '/home/rafaelluckner/Documentos/repos/ds_em_producao/'
    ...
    def feature_engeneering(self, df2):
        ...
        df2['week_of_year'] = df2['year_week'].apply(lambda x: int(x.split('-')[1]))
    ...
    def data_preparation(self, df5):
        ...
        expected_columns = ['state_holiday_christmas', 'state_holiday_easter_holiday', 
        ...
        cols_selected=  ['store','promo','store_type','assortment','competition_distance','competition_open_since_month',
                                 ...
                                 'promo_time_week','day_of_week_sin','day_of_week_cos','day_sin','day_cos','week_of_year_sin','week_of_year_cos',
                                 'month_cos','month_sin']
